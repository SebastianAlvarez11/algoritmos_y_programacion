from softwaregimnasio.modelo.membresia import Membresia
from softwaregimnasio.modelo.medidas import Medidas
from softwaregimnasio.modelo.asistencia import Asistencia
