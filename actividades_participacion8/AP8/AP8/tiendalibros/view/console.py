...
class UIConsola:
    ...
    def retirar_libro_de_carrito_de_compras(self):
        ...
        self.tienda_libros.carrito.quitar_item(isbn)
        print("Exito")

    def agregar_libro_a_carrito_de_compras(self):
        isbn:str = input("Ingrese el ISBN a agregar: ")
        cantidad:int = int(input("Ingrese la cantidad:"))
        libro = self.tienda_libros.catalogo.get(isbn)
        print("Libro agregado al carrito: {}, cantidad: {}". format(libro, cantidad))
    ...
    def adicionar_un_libro_a_catalogo(self):
        ...
        existencias: int = int(input("Ingrese las existencias: "))
        libro = self.tienda_libros.adicionar_libro_a_catalogo(isbn, titulo, precio, existencias)
        print("Libro agregado al catalogo: {}". format(libro.titulo))
